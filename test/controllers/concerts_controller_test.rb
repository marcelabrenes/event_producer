...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { date: @concert.date, duration: @concert.duration, location: @concert.location, quanity: @concert.quanity } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { date: @concert.date, duration: @concert.duration, location: @concert.location, quanity: @concert.quanity } }
